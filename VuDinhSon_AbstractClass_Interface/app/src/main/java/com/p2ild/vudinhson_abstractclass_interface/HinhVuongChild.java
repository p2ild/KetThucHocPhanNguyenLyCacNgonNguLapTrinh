 ...
 * Ông con có tên hình vuông thực chất là 1 hình tứ giác đặc biệt nên sẽ có các đặc điểm cũng như hành động của ông bố
 * Để cho con kế thừa ông bố ở đây ta sẽ dùng từ khóa Extends
 */
public class HinhVuongChild extends TuGiacAbstract {
    ...
    * */
    public HinhVuongChild(double canhA, double canhB, double canhC, double canhD) {
    ...
    * Các class con implement itnterface đó và phải Override tất cả các method đó*/
    ...
    public void hienThiChuVi(Context context) {
        Toast.makeText(context, "Chu vi hình vuông là : "+chuVi, Toast.LENGTH_SHORT).show();
    }

    @Override
    public void hienThiDienTich(Context context) {
        Toast.makeText(context, "Diện tích hình vuông là : "+dienTich, Toast.LENGTH_SHORT).show();
    }
}
